...
function IssueContent({
  ...
  const issue = useQuery(api.issues.getByMarketDate, {
    marketId: market._id,
    issueDate,
  });
  ...
  return <IssueView issueId={issue._id} issue={issue} market={market} />;
}
...
export default function IssuePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <IssueContent market={market} issueDate={issueDate} />
    </div>
  );
}
